...
<head>
	<meta charset="UTF-8">
	<title>Miro June example 4</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                <li>
                    <a href="/tryvid4">Home</a>
                </li>
                <li>
                    <a href="/vid4page">About</a>
                </li>
                <li>
                    <a href="/vid4page">Events</a>
                </li>
                <li>
                    <a href="/vid4page">Team</a>
                </li>
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Works <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li class="dropdown-header">Dropdown heading</li>
                    <li><a href="/vid4page">Action</a></li>
                    <li><a href="/vid4page">Another action</a></li>
                    <li><a href="/vid4page">Something else here</a></li>
                    <li><a href="/vid4page">Separated link</a></li>
                    <li><a href="/vid4page">One more separated link</a></li>
                  </ul>
                </li>
                <li>
                    <a href="/vid4page">Services</a>
                </li>
                <li>
                    <a href="/vid4page">Contact</a>
                </li>
                <li>
                    <a href="/vid4page">Follow me</a>
                </li>
            </ul>
        </nav>
        <!-- /#sidebar-wrapper -->
