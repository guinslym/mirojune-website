...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="/crystal/css/font-awesome.min.css">
    <link rel="stylesheet" href="/crystal/css/line-icons.css">
    <link rel="stylesheet" href="/crystal/css/animate.css">
  ...
  <!--
   ...
   -->
    ...
    <header id="video-area" data-stellar-background-ratio="0.5">    
      <div id="block" data-vide-bg="/uploads/YdZKxE_Flower_Ceiling.mp4" style="min-height: 210px;" class="wow"></div>
        ...
        <div class="row ">
          <div class="col-md-10">
            <div class="contents text-center">
              ...
              <a href="#" class="btn btn-common wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms"><i class="lnr lnr-download"></i> </a>
            </div>
          </div>
        </div> 
      </div>      
...
@include('frontend.partials.socials')
   ...
   $(window).load(function() {
    ...
    <script src="/crystal/js/tether.min.js"></script>
    <script src="/crystal/js/bootstrap.min.js"></script>
    <script src="/crystal/js/jquery.vide.js"></script>
